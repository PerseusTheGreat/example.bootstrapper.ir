...
- Latest dist.: [Version 4.1.3 (Official, Weekly build) + RTL 4.1.3 rev.2 (Unofficial)](https://perseusthegreat.github.io/bs4rtl-examples/archive/bootstrap-4.1.3-plus-rtl-rev.2-dist.zip)
